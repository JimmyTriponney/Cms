...
class CprMenuSubDropdownType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'JT\MenuComposerBundle\Entity\CprMenuSubDropdown'
        ));
    }
    ...
    {
        return 'jt_menucomposerbundle_cprmenusubdropdown';
    }
